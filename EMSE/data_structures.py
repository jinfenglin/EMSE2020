...
from EMSE.models import TBERT, TBertSingle
...
class Examples:
    ...
    def update_features(self, model: TBERT):
        """
    ...
    def update_embd(self, model: TBERT):
        """
    ...
    def __rank_and_select(self, model: TBERT, batch_size, top_n, search_space_percent=1.0):
        """
    ...
    def make_online_neg_sampling_batch(self, batch: Tuple, model: TBERT, hard_ratio):
        """
    ...
    def make_online_triplet_sampling_batch(self, batch: Tuple, model: TBERT):
        nl_ids = batch[0].tolist()
        pl_ids = batch[1].tolist()
